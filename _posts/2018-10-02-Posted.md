...
<p style="border:1px black solid;color:black;font-size:14px;font-family: 'Courier New', Courier, monospace;">
Extracting data/MNIST/train-images-idx3-ubyte.gz<br>
